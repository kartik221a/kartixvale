...
// Separated by series for the Books page
export const beneathTheVeilSeries: BookData[] = [
  // Book One
  booksData.find(b => b.series === "Beneath the Veil — Book One")!,
  // Book Two
  booksData.find(b => b.series === "Beneath the Veil — Book Two")!,
  // Book Three
  booksData.find(b => b.series === "Beneath the Veil — Book Three")!,
  // Book Four (Finale)
  booksData.find(b => b.series?.includes("Book Four"))!,
];

export const standaloneNovels: BookData[] = booksData.filter(
  b => b.series === "Standalone"
);
